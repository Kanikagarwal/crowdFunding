      ...
      <div className="bg-[#1A9E83] text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-2xl mx-auto opacity-90">
            Explore {campaigns.length} innovative projects from creators around
            the world.
          </p>
        </div>
      </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-colors whitespace-nowrap ${
                filterCategory === cat
                  ...
                  : "bg-white border text-gray-600 hover:bg-gray-100 dark:bg-[#1f2028] dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700"
              }`}
            >
              {cat}
            </button>
