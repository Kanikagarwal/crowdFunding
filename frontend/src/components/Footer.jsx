        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-300 mt-3 text-sm leading-6">
              Helping creators and communities raise funds for ideas that
              matter.
            </p>
            ...
            <div className="flex gap-3 mt-4">
              <a
                href="#"
                className="h-8 w-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#1A9E83] transition hover:scale-110"
              >
                <FaInstagram size={14} />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li>
                <a href="#" className="hover:text-[#1A9E83] transition">
                  Home
                </a>
              </li>
              <li>
